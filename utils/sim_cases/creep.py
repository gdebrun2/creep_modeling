...
def build_fft(cfg: FftConfig) -> str:
    ...
    if cfg.load is None:
        raise ValueError("cfg.load is required for creep_stress")
    load = float(cfg.load)
    NSEC = 14 * 24 * 60 * 60
    NPROC = 17
    ...
    NSEC3 = 14400
    NSEC4 = 64080
    NSEC5 = NSEC - NSEC1 - NSEC2 - NSEC3 - NSEC4  # 1,126,800
    ...
    TDOT0 = 1
    TDOT1 = NSEC1 / NSTEPS1  # 7s
    TDOT2 = NSEC2 / NSTEPS2  # 9s
    TDOT3 = NSEC3 / NSTEPS3  # 36s
...
* boundary conditions                                                     
	...
	0.      0.       0.          scauchy  |    Cauchy stress              
			0.       0.                   |                               
					 56                   @                               
* other                                                                   
{TDOT0} 1 1e-2 {DEVMMX}  eqincr or tdot, tdotref, tdotmin, devmmx
